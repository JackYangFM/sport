    ...
    <div class="parent">
        <div class="p-container">
            <div class="pc-content">
                <h1 class="pcc-title">尊敬的家长您好，为方便{{parentDataHhl.course_time}}安排上课，请选择孩子明天上课的时间段，谢谢您的配合！</h1>
                            ...
                            <div class="pccc-left">
                                <ul class="pcccl-ul">
                                    <li>
                                        ...
                                        <div class="pcccl-text" v-for="(item,index) in parentDataHhl.rows" :key="index">
                                    ...
                                    <li>
                                        ...
                                        <div class="pcccl-text">
                                            <span>{{parentDataHhl.course_content}}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="pcccl-name">集合地点：</div>
                                        <div class="pcccl-text">
                                            <span>{{parentDataHhl.site}}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="pcccl-name">所需器材：</div>
                                        <div class="pcccl-text">
                                            <span>{{parentDataHhl.sports_equipment}}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="pcccl-name">其他：</div>
                                        <div class="pcccl-text">
                                            <span>{{parentDataHhl.other_content}}</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<script>
    ...
    import {HuaiHeLuSelect, studentInsert} from "@/service/parent"
    ...
    export default {
        ...
        created() {
            ...
            HuaiHeLuSelect().then((res) => {
                this.parentDataHhl = res
            })
        },
        methods: {
            handleSubmit() {
                this.$refs['formValidate'].validate((valid) => {
                    if (valid) {
                        studentInsert(Object.assign(this.formValidate, {campus_id: 3})).then(res => {
                           return
                        })
                    }
                })
