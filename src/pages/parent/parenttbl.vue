                                ...
                                <ul class="pcccl-ul">
                                    <li>
                                        ...
                                        <div class="pcccl-text">
                                            <span v-for="(item,index) in parentDataTbl.rows" :key="index">
    ...
    export default {
        ...
        data() {
            return {
                ...
                table: {
                    mock: false,
                    url: 'serviceManage/course_manage/TongBaiLu_select',
        ...
        methods: {
            handleSubmit() {
                this.$refs['formValidate'].validate((valid) => {
                    if (valid) {
                        studentInsert(Object.assign(this.formValidate, {campus_id: 2})).then(res => {
