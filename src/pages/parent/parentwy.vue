    ...
    <div class="parent">
        <div class="p-container">
            <div class="pc-content">
                <h1 class="pcc-title">尊敬的家长您好，为方便{{parentDataWy.course_time}}安排上课，请选择孩子明天上课的时间段，谢谢您的配合！</h1>
                            ...
                            <div class="pccc-left">
                                <ul class="pcccl-ul">
                                    ...
                                    <li>
                                        ...
                                        <div class="pcccl-text">
                                            <span>{{parentDataWy.course_content}}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="pcccl-name">集合地点：</div>
                                        <div class="pcccl-text">
                                            <span>{{parentDataWy.site}}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="pcccl-name">所需器材：</div>
                                        <div class="pcccl-text">
                                            <span>{{parentDataWy.sports_equipment}}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="pcccl-name">其他：</div>
                                        <div class="pcccl-text">
                                            <span>{{parentDataWy.other_content}}</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<script>
    ...
    import {WuYiSelect, studentInsert} from "@/service/parent"
    ...
    export default {
        ...
        data() {
            return {
                ...
                table: {
                    mock: false,
                    url: 'serviceManage/course_manage/WuYi_select',
